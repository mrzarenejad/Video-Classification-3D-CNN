...
def parse_opts():
    ...
    parser.add_argument('--video_root', default="D:/Users/zare/DeepLearning/VideoCaption/Dataset/EMVIDCAP/EmVidCap/Videos/EmVidCap-C/dataset/MSRVTT/all_frames/all_videos", type=str, help='Root path of input videos')
    parser.add_argument('--model', default="D:/Users/zare/DeepLearning/VideoCaption/Dataset/EMVIDCAP/EmVidCap/Videos/EmVidCap-C/code/video-classification-3d-cnn-master/3d-resnet-pytorch/resnext-101-64f-kinetics-hmdb51_split1.pth", type=str, help='Model file path')
    ...
    parser.add_argument('--no_cuda', action='store_false', help='If true, cuda is not used.')
    parser.set_defaults(verbose=False)
    parser.add_argument('--verbose', action='store_true', help='')
    parser.set_defaults(verbose=False)

    parser.add_argument('--gpu', default='0', type=str)
    parser.add_argument('--feats_dir', default='D:/Users/zare/DeepLearning/VideoCaption/Dataset/EMVIDCAP/EmVidCap/Videos/EmVidCap-C/dataset/MSRVTT/feats/', type=str)
